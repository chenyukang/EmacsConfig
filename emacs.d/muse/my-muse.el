...
(setq muse-project-alist
      '(
	("Computer"
	 ("~/document/wiki/Home/Computer/" :default "index")
	 (:base "html" :path "~/document/wiki/Home_Page/Computer"))
	("MovieMusic"
	 ("~/document/wiki/Home/MovieMusic" :default "index")
	 (:base "html" :path "~/document/wiki/Home_Page/MovieMusic"))
	("Sport"
	 ("~/document/wiki/Home/Sport" :default "index")
	 (:base "html" :path "~/document/wiki/Home_Page/Sports"))
	("Other"
	 ("~/document/wiki/Home/Other" :defualt "index")
	 (:base "html" :path "~/document/wiki/Home_Page/Other"))
	("Photo"
	 ("~/document/wiki/Home/Photo" :default "index")
	 (:base "html" :path "~/document/wiki/Home_Page/Photo"))))

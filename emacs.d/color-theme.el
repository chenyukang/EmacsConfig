...
fonts."
  ...
  (color-theme-install
   '(color-theme-midnight
     ...
     (font-lock-function-name-face ((t (:bold t :foreground "Red" :weight extra-bold :family "outline-verdana"))))
...
(defun color-theme-deep-blue ()
   ...
   (color-theme-install
    '(color-theme-deep-blue
      ...
      (font-lock-function-name-face ((t (:bold t :foreground "YellowGreen" :family "outline-verdana"))))
